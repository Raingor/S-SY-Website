...
export default function AdminPage() {
  ...
  const menu = [['overview', BarChart3, '总览'], ['routes', FileText, '路线管理'], ['destinations', MapPinned, '目的地'], ['leads', Users, '咨询 CRM'], ['guideBookings', CalendarDays, '导游预约'], ['miniProgramBookings', Smartphone, '小程序预约'], ['settings', Settings, '站点配置']]
