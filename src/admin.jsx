...
const defaultSettings = { siteName: '', siteUrl: '', defaultTitle: '', defaultDescription: '', keywords: '', ogImage: '', googleVerification: '', robotsPolicy: 'index,follow', wechat: '', phone: '', email: '', replyHours: '', miniprogramAccess: true }
...
function DestinationTypesPanel({ title, items, onSave, onDelete, onStatusChange }) {
  const [editing, setEditing] = useState(null)
