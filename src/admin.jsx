...
const [destinationTypes, setDestinationTypes] = useState([])
  ...
  async function load() {
    ...
    try {
      ...
      if (nextHomeBanners) setHomeBanners(Array.isArray(nextHomeBanners) ? nextHomeBanners : [])
  ...
  const menu = [['overview', BarChart3, '总览'], ['countries', MapPinned, '国家管理'], ['guides', Users, '导游管理'], ['routes', FileText, '路线管理'], ['cities', MapPinned, '城市与价格'], ['destinationTypes', MapPinned, '目的地分类'], ['destinations', MapPinned, '目的地'], ['attractions', Landmark, '景点管理'], ['sampleItineraries', MapPinned, '参考行程'], ['customTrips', Link2, '定制行程'], ['leads', Users, '咨询 CRM'], ['guideBookings', CalendarDays, '导游预约'], ['miniProgramBookings', Smartphone, '小程序预约'], ['miniprogramUsers', Users, '小程序用户'], ['miniprogramOrders', CreditCard, '订单管理'], ['miniprogramTrips', MapPinned, '小程序行程'], ['miniprogramTravelers', Users, '出行人资料'], ['miniprogramDocuments', FileText, '签证资料'], ['miniprogramCoupons', CalendarDays, '优惠券'], ['homeBanners', Images, '首页 Banner'], ['settings', Settings, '站点配置']]
  const menuGroups = [['共同数据', ['overview', 'countries', 'guides', 'leads', 'guideBookings']], ['网站管理', ['routes', 'cities', 'destinationTypes', 'destinations', 'attractions', 'sampleItineraries', 'customTrips', 'homeBanners', 'settings']], ['小程序管理', ['miniProgramBookings', 'miniprogramUsers', 'miniprogramOrders', 'miniprogramTrips', 'miniprogramTravelers', 'miniprogramDocuments', 'miniprogramCoupons']]]
