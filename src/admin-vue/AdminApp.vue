  ...
  <div class="el-admin">
    ...
    <el-container v-else class="admin-layout">
      <el-aside width="232px" class="admin-aside">
        ...
        <el-menu :default-active="active" unique-opened class="side-menu" background-color="#20222a" text-color="#aeb3bd" active-text-color="#fff" @select="selectMenu">
...
const groups = [
  ...
  { label:'路线与目的地', items:[['routes','路线管理','el-icon-document'],['cities','城市与价格','el-icon-location-outline'],['destinationTypes','目的地分类','el-icon-collection-tag'],['destinations','目的地','el-icon-map-location'],['attractions','景点管理','el-icon-school'],['sampleItineraries','参考行程','el-icon-guide']] },
  { label:'网站管理', items:[['homeBanners','首页 Banner','el-icon-picture'],['settings','站点配置','el-icon-setting']] },
  { label:'小程序管理', items:[['miniProgramBookings','小程序预约','el-icon-mobile-phone'],['miniprogramBanners','小程序 Banner','el-icon-picture-outline'],['miniprogramUsers','小程序用户','el-icon-user'],['miniprogramOrders','订单管理','el-icon-s-finance'],['miniprogramTrips','小程序行程','el-icon-map-location'],['customTrips','定制行程订单','el-icon-link'],['miniprogramTravelers','出行人资料','el-icon-user-solid'],['miniprogramDocuments','签证资料','el-icon-document'],['miniprogramCoupons','优惠券','el-icon-s-ticket']] },
]
...
export default {
  ...
  methods:{
    ...
    selectMenu(id){this.active=id;this.editor=null;this.filterText='';this.attractionDestinationFilter='';this.attractionView='list';this.clearFilterValues();this.resetPagination()},
