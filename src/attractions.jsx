...
export function CustomTripPage() {
  ...
  useEffect(() => { if (trip) document.title = `${trip.title}｜${trip.client} · SY 希腊蔚蓝海岸` }, [trip])
      ...
      <main className="trip-page section">
        <div className="container">
          ...
          <div className="trip-contact">
            ...
            <div><Ship size={20} /><div><strong>希腊蔚蓝海岸</strong><span>Ikoniou 94, Nea Smyrni 17123, Athens · 手机 +30-6973573863</span></div></div>
